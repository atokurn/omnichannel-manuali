...
const ApiSyncSection = ({
  ...
  const onFieldValueChange = (platform: string, field: string, value: any) => {
    setFieldValues(prev => ({
      ...prev,
                ...
                <Card key={platform} className="mt-4">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {platform === 'TikTok Shop' && (
                      <>
                        <div className="space-y-2">
                          ...
                          <Select
                            onValueChange={(value) => onFieldValueChange('tiktok', 'condition', value)}
                        ...
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) => onFieldValueChange('tiktok', 'insurance', checked)}
                          />
                      ...
                      <>
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) => onFieldValueChange('shopee', 'free_shipping', checked)}
                          />
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            onValueChange={(value) => onFieldValueChange('shopee', 'warranty', value)}
                      ...
                      <>
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) => onFieldValueChange('tokopedia', 'power_merchant', checked)}
                          />
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center space-x-2">
                            <Switch
                              ...
                              onCheckedChange={(checked) => onFieldValueChange('tokopedia', 'preorder', checked)}
                            />
                          ...
                          {fieldValues['tokopedia_preorder'] && (
                            <div className="ml-6 mt-2">
                              ...
                              <Input
                                ...
                                onChange={(e) => onFieldValueChange('tokopedia', 'preorder_days', e.target.value)}
                              />
                            </div>
                          )}
                        </div>
                    ...
                    <div className="space-y-2 mt-4">
                      ...
                      <Select
                        onValueChange={(value) => onFieldValueChange(platform.toLowerCase().replace(' ', '_'), 'category', value)}
