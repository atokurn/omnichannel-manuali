...
export function SignupForm({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Ganti '/api/auth/signup' dengan endpoint API Anda yang sebenarnya
      ...
      if (!response.ok) {
        let errorMessage = 'Gagal mendaftar'; // Default error message
        try {
          const errorData = await response.json();
          // Use the 'error' property from the API response
