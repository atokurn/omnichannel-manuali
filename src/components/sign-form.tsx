...
import { AlertCircle, Loader2, Eye, EyeOff } from "lucide-react" // Import Eye and EyeOff icons
...
export function SignForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Ganti '/api/auth/login' dengan endpoint API login Anda yang sebenarnya
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                <div className="flex items-center">
                  ...
                  <a
                    href="#" // Ganti dengan link reset password yang sebenarnya
